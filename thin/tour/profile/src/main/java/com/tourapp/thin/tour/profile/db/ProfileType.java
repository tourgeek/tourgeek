...
public class ProfileType extends FieldList
    implements ProfileTypeModel
{
    ...
    public ProfileType(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? ProfileType.PROFILE_TYPE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
