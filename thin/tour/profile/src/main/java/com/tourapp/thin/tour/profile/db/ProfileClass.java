...
public class ProfileClass extends FieldList
    implements ProfileClassModel
{
    ...
    public ProfileClass(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? ProfileClass.PROFILE_CLASS_FILE : super.getTableNames(bAddQuotes);
    }
    /**
