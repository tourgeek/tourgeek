...
public class PaymentCode extends FieldList
    implements PaymentCodeModel
{
    ...
    public PaymentCode(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? PaymentCode.PAYMENT_CODE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
