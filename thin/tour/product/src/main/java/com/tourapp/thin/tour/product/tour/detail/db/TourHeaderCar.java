...
public class TourHeaderCar extends com.tourapp.thin.tour.product.tour.detail.db.TourHeaderTransport
{
    ...
    public TourHeaderCar(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourHeaderCar.TOUR_HEADER_CAR_FILE : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    */
    public void setupFields()
    {
        ...
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "Inventory", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "SendTourOrder", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
    }
    /**
