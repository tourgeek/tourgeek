...
public class HotelRate extends FieldList
{
    ...
    public HotelRate(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? HotelRate.HOTEL_RATE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    */
    public void setupFields()
    {
        ...
        field = new FieldInfo(this, "GeneralRate", 10, null, new Boolean(true));
        field.setDataClass(Boolean.class);
    }
    /**
