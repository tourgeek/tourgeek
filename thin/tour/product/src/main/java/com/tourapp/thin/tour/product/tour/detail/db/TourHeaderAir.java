...
public class TourHeaderAir extends com.tourapp.thin.tour.product.tour.detail.db.TourHeaderTransport
{
    ...
    public TourHeaderAir(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourHeaderAir.TOUR_HEADER_AIR_FILE : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    */
    public void setupFields()
    {
        ...
        field.setDataClass(Integer.class);
        field = new FieldInfo(this, "ProductID", 4, null, null);
        field.setDataClass(Integer.class);
