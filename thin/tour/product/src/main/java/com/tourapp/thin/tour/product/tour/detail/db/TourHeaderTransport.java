...
public class TourHeaderTransport extends com.tourapp.thin.tour.product.tour.detail.db.TourHeaderDetail
{
    ...
    public TourHeaderTransport(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourHeaderTransport.TOUR_HEADER_TRANSPORT_FILE : super.getTableNames(bAddQuotes);
    }
    /**
