...
public class TourType extends FieldList
{
    ...
    public TourType(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourType.TOUR_TYPE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
