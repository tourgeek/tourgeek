...
public class TransportationClass extends FieldList
{
    ...
    public TransportationClass(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TransportationClass.TRANSPORTATION_CLASS_FILE : super.getTableNames(bAddQuotes);
    }
    /**
