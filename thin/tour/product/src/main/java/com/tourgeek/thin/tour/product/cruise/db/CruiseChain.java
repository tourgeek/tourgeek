...
package com.tourgeek.thin.tour.product.cruise.db;
    ...
    implements CruiseChainModel
{
    ...
    public CruiseChain(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? CruiseChain.CRUISE_CHAIN_FILE : super.getTableNames(bAddQuotes);
    }
    /**
