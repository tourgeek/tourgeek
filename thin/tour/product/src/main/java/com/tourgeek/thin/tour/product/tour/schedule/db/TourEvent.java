...
public class TourEvent extends FieldList
    implements TourEventModel
{
    ...
    public TourEvent(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourEvent.TOUR_EVENT_FILE : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    */
    public void setupFields()
    {
        ...
        field = new FieldInfo(this, BOOKING_OR_TOUR, Constants.DEFAULT_FIELD_LENGTH, null, null);
        field = new FieldInfo(this, EVENT_OR_DATE, Constants.DEFAULT_FIELD_LENGTH, null, null);
    }
    /**
