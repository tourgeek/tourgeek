...
import com.tourgeek.thin.tour.product.tour.detail.db.*;
    ...
    implements TourHeaderItemModel
{
    ...
    public TourHeaderItem(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourHeaderItem.TOUR_HEADER_ITEM_FILE : super.getTableNames(bAddQuotes);
    }
    /**
