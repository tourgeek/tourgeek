    ...
    implements BookingAirModel
{
    ...
    */
    public void setupKeys()
    {
        ...
        keyArea = new KeyAreaInfo(this, Constants.NOT_UNIQUE, BOOKING_AIR_HEADER_ID_KEY);
        keyArea.addKeyField(BOOKING_AIR_HEADER_ID, Constants.ASCENDING);
        keyArea.addKeyField(BOOKING_PAX_ID, Constants.ASCENDING);
        keyArea.addKeyField(GMT_DATE, Constants.ASCENDING);
        keyArea = new KeyAreaInfo(this, Constants.NOT_UNIQUE, CARRIER_KEY);
