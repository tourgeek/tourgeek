...
public class HotelInventory extends com.tourapp.thin.tour.booking.inventory.db.Inventory
{
    ...
    public HotelInventory(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? HotelInventory.HOTEL_INVENTORY_FILE : super.getTableNames(bAddQuotes);
    }
    /**
