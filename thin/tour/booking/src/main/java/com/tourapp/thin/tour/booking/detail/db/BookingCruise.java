...
public class BookingCruise extends com.tourapp.thin.tour.booking.detail.db.BookingDetail
{
    ...
    public BookingCruise(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? BookingCruise.BOOKING_CRUISE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
