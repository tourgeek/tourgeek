...
public class LandInventory extends com.tourapp.thin.tour.booking.inventory.db.Inventory
{
    ...
    public LandInventory(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? LandInventory.LAND_INVENTORY_FILE : super.getTableNames(bAddQuotes);
    }
    /**
