...
public class BookingLand extends com.tourapp.thin.tour.booking.detail.db.BookingDetail
{
    ...
    public BookingLand(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? BookingLand.BOOKING_LAND_FILE : super.getTableNames(bAddQuotes);
    }
    /**
