...
public class CruiseInventory extends com.tourapp.thin.tour.booking.inventory.db.Inventory
{
    ...
    public CruiseInventory(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? CruiseInventory.CRUISE_INVENTORY_FILE : super.getTableNames(bAddQuotes);
    }
    /**
