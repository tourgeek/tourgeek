...
public class BookingItem extends com.tourapp.thin.tour.booking.detail.db.BookingDetail
{
    ...
    public BookingItem(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? BookingItem.BOOKING_ITEM_FILE : super.getTableNames(bAddQuotes);
    }
    /**
