...
public class TransportationInventory extends com.tourapp.thin.tour.booking.inventory.db.Inventory
{
    ...
    public TransportationInventory(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TransportationInventory.TRANSPORTATION_INVENTORY_FILE : super.getTableNames(bAddQuotes);
    }
    /**
