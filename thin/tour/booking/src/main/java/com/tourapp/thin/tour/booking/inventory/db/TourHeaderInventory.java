...
public class TourHeaderInventory extends com.tourapp.thin.tour.booking.inventory.db.Inventory
{
    ...
    public TourHeaderInventory(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? TourHeaderInventory.TOUR_HEADER_INVENTORY_FILE : super.getTableNames(bAddQuotes);
    }
    /**
