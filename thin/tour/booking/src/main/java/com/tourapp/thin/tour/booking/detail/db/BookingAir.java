...
public class BookingAir extends com.tourapp.thin.tour.booking.detail.db.BookingDetail
{
    ...
    public BookingAir(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? BookingAir.BOOKING_AIR_FILE : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    */
    public void setupFields()
    {
        ...
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "InventoryMessageLogID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "InfoMessageLogID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "ProductMessageLogID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "TotalCostUSD", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "CostMessageLogID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
        field = new FieldInfo(this, "DetailDeleted", Constants.DEFAULT_FIELD_LENGTH, null, null);
        field.setDataClass(Object.class);
    }
    /**
    ...
    */
    public void setupKeys()
    {
        ...
        keyArea = new KeyAreaInfo(this, Constants.NOT_UNIQUE, "BookingAirHeaderID");
        keyArea.addKeyField("BookingAirHeaderID", Constants.ASCENDING);
        keyArea.addKeyField("BookingPaxID", Constants.ASCENDING);
        keyArea.addKeyField("GMTDate", Constants.ASCENDING);
        keyArea = new KeyAreaInfo(this, Constants.NOT_UNIQUE, "Carrier");
        keyArea.addKeyField("Carrier", Constants.ASCENDING);
