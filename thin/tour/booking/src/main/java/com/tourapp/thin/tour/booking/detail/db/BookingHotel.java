...
public class BookingHotel extends com.tourapp.thin.tour.booking.detail.db.BookingDetail
{
    ...
    public BookingHotel(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? BookingHotel.BOOKING_HOTEL_FILE : super.getTableNames(bAddQuotes);
    }
    /**
