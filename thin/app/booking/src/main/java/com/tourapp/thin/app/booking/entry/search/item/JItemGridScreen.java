 ...
 */
public class JItemGridScreen extends JProductGridScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JItemGridScreen(Object parent, Object model)
    {
        this();
    ...
    {
        return new JItemScreen(this.getParentObject(), record);
    }
    /**
    ...
    {
        return new ItemGridModel(table);
    }
}
