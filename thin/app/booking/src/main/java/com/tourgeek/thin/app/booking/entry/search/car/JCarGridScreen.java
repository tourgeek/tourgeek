 ...
 */
package com.tourgeek.thin.app.booking.entry.search.car;
 ...
 */
public class JCarGridScreen extends JProductGridScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JCarGridScreen(Object parent, Object model)
    {
        this();
    ...
    {
        return new JCarScreen(this.getParentObject(), record);
    }
    /**
