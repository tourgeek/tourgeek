 ...
 */
public class JCruiseGridScreen extends JProductGridScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JCruiseGridScreen(Object parent, Object model)
    {
        this();
    ...
    {
        return new JCruiseScreen(this.getParentObject(), record);
    }
    /**
    ...
    {
        return new CruiseGridModel(table);
    }
}
