 ...
 */
package com.tourgeek.thin.app.booking.entry.detail.item;
...
import com.tourgeek.thin.tour.booking.detail.db.BookingItem;
import com.tourgeek.thin.tour.product.item.db.Item;
import com.tourgeek.thin.tour.product.item.db.ItemClass;

/**
 * Main Class for applet OrderEntry
 */
public class JBookingItemScreen extends JBaseBookingDetailScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JBookingItemScreen(Object parent, Object obj)
    {
        this();
    ...
    {
        return new BookingItem(this);  // If overriding class didn't set this
    }
    /**
    ...
    public JComponent createScreenComponent(Converter fieldInfo)
    {
        ...
        {
            ItemClass recItemClass = new ItemClass(this);
            component = new JRemoteComboBox(applet, this.getRemoteSession(null), recItemClass, applet.getString(BookingConstants.ITEM_CLASS), ItemClass.DESCRIPTION, BookingConstants.ITEM_CLASS, true, ItemClass.ID, null);
        }
        else
