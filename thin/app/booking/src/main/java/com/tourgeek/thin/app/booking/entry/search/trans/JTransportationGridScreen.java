 ...
 */
public class JTransportationGridScreen extends JProductGridScreen
{
     ...
     */
    public JTransportationGridScreen()
    {
        super();
    }
    /**
     *  OrderEntry Class Constructor.
     */
    public JTransportationGridScreen(Object parent, Object model)
    {
        this();
    ...
    {
        return new JTransportationScreen(this.getParentObject(), record);
    }
    /**
    ...
    {
        return new TransportationGridModel(table);
    }
}
