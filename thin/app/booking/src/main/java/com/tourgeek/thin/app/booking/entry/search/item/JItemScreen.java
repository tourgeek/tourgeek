 ...
 */
public class JItemScreen extends JProductScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JItemScreen(Object parent, Object obj)
    {
        this();
    ...
    {
        return new JItemGridScreen(this.getParentObject(), record);
    }
    /**
