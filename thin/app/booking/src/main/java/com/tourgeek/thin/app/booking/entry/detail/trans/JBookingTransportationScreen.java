 ...
 */
package com.tourgeek.thin.app.booking.entry.detail.trans;
...
import com.tourgeek.thin.tour.booking.detail.db.BookingTransportation;
import com.tourgeek.thin.tour.product.trans.db.Transportation;
import com.tourgeek.thin.tour.product.trans.db.TransportationClass;

/**
 * Main Class for applet OrderEntry
 */
public class JBookingTransportationScreen extends JBaseBookingDetailScreen
{
     ...
     */
    public JBookingTransportationScreen()
    {
        super();
    }
    /**
     *  OrderEntry Class Constructor.
     */
    public JBookingTransportationScreen(Object parent, Object obj)
    {
        this();
    ...
    {
        return new BookingTransportation(this);  // If overriding class didn't set this
    }
    /**
    ...
    public JComponent createScreenComponent(Converter fieldInfo)
    {
        ...
        {
            TransportationClass recTransportationClass = new TransportationClass(this);
            component = new JRemoteComboBox(applet, this.getRemoteSession(null), recTransportationClass, applet.getString(BookingConstants.TRANSPORTATION_CLASS), TransportationClass.DESCRIPTION, BookingConstants.TRANSPORTATION_CLASS, true, TransportationClass.ID, null);
        }
        else
