 ...
 */
package com.tourgeek.thin.app.booking.entry.detail.cruise;
...
import com.tourgeek.thin.tour.booking.detail.db.BookingCruise;
import com.tourgeek.thin.tour.booking.detail.db.BookingDetail;
import com.tourgeek.thin.tour.product.cruise.db.Cruise;
import com.tourgeek.thin.tour.product.cruise.db.CruiseClass;

/**
 * Main Class for applet OrderEntry
 */
public class JBookingCruiseScreen extends JBaseBookingDetailScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public JBookingCruiseScreen(Object parent, Object obj)
    {
        this();
    ...
    {
        return new BookingCruise(this);  // If overriding class didn't set this
    }
    /**
    ...
    public JComponent createScreenComponent(Converter fieldInfo)
    {
        ...
        {
            CruiseClass recCruiseClass = new CruiseClass(this);
            component = new JRemoteComboBox(applet, this.getRemoteSession(null), recCruiseClass, applet.getString(BookingConstants.CRUISE_CLASS), CruiseClass.DESCRIPTION, BookingConstants.CRUISE_CLASS, true, CruiseClass.ID, null);
        }
        else
