 ...
 *  ArTrxHeaderScreen - .
 */
public class ArTrxHeaderScreen extends HeaderScreen
{
    /**
     * Default constructor.
     */
    public ArTrxHeaderScreen()
    {
        super();
    }
    /**
     ...
     */
    public ArTrxHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
