...
public class BaseArPayDistHeaderScreen extends HeaderScreen
{
     ...
     */
    public BaseArPayDistHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
