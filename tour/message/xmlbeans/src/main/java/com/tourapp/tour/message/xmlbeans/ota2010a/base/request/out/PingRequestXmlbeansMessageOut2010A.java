/**
 *  @(#)PingRequestXmlbeansMessageOut2010A.
 *  Copyright © 2010 tourapp.com. All rights reserved.
 */
package com.tourapp.tour.message.xmlbeans.ota2010a.base.request.out;
 ...
 *  PingRequestXmlbeansMessageOut2010A - .
 */
public class PingRequestXmlbeansMessageOut2010A extends XmlbeansConvertToNative
{
    /**
     * Default constructor.
     */
    public PingRequestXmlbeansMessageOut2010A()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestXmlbeansMessageOut2010A(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
