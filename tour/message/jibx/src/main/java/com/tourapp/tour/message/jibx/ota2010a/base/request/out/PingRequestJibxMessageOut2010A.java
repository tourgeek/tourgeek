/**
 *  @(#)PingRequestJibxMessageOut2010A.
 ...
 *  PingRequestJibxMessageOut2010A - .
 */
public class PingRequestJibxMessageOut2010A extends BaseJibxMessageOut2010A
{
    /**
     * Default constructor.
     */
    public PingRequestJibxMessageOut2010A()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestJibxMessageOut2010A(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
