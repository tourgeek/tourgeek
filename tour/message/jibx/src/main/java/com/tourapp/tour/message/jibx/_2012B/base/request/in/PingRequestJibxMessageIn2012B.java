 ...
 *  PingRequestJibxMessageIn2012B - .
 */
public class PingRequestJibxMessageIn2012B extends BaseJibxMessageIn2012B
{
    /**
     * Default constructor.
     */
    public PingRequestJibxMessageIn2012B()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestJibxMessageIn2012B(ExternalTrxMessageIn message)
    {
        this();
        this.init(message);
    }
