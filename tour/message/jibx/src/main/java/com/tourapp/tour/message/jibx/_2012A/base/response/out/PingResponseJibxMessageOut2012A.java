/**
  * @(#)PingResponseJibxMessageOut2012A.
...
import com.tourapp.tour.message.jibx._2012A.base.request.out.*;
 ...
 *  PingResponseJibxMessageOut2012A - .
 */
public class PingResponseJibxMessageOut2012A extends BaseJibxMessageOut2012A
{
    /**
     * Default constructor.
     */
    public PingResponseJibxMessageOut2012A()
    {
        super();
    }
    /**
     ...
     */
    public PingResponseJibxMessageOut2012A(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
