 ...
 *  BaseJibxMessageOut2012B - .
 */
public class BaseJibxMessageOut2012B extends JibxConvertToNative
{
    /**
     * Default constructor.
     */
    public BaseJibxMessageOut2012B()
    {
        super();
    }
    /**
     ...
     */
    public BaseJibxMessageOut2012B(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
