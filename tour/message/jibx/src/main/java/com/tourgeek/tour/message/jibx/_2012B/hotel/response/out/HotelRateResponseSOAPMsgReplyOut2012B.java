...
package com.tourgeek.tour.message.jibx._2012B.hotel.response.out;
 ...
 */
public class HotelRateResponseSOAPMsgReplyOut2012B extends JibxConvertToNative
{
    /**
     * Default constructor.
     */
    public HotelRateResponseSOAPMsgReplyOut2012B()
    {
        super();
    }
    /**
     ...
     */
    public HotelRateResponseSOAPMsgReplyOut2012B(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
