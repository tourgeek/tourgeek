/**
  ...
  */
package com.tourgeek.tour.message.jibx._2012B.hotel.request.in;
 ...
 *  HotelRateRequestSOAPMessageIn2012B - .
 */
public class HotelRateRequestSOAPMessageIn2012B extends BaseJibxMessageIn2012B
{
    /**
     * Default constructor.
     */
    public HotelRateRequestSOAPMessageIn2012B()
    {
        super();
    }
    /**
     ...
     */
    public HotelRateRequestSOAPMessageIn2012B(ExternalTrxMessageIn message)
    {
        this();
        this.init(message);
    }
