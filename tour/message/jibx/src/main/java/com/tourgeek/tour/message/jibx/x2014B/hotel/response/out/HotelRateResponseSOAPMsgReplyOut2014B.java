/**
  ...
  */
package com.tourgeek.tour.message.jibx.x2014B.hotel.response.out;
...
public class HotelRateResponseSOAPMsgReplyOut2014B extends JibxConvertToNative
{
     ...
     * Default constructor.
     */
    public HotelRateResponseSOAPMsgReplyOut2014B()
    {
        super();
    }
    /**
     ...
     */
    public HotelRateResponseSOAPMsgReplyOut2014B(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
