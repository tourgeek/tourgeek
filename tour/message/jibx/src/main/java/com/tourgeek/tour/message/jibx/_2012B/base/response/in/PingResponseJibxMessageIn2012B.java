/**
  * @(#)PingResponseJibxMessageIn2012B.
  * Copyright © 2013 tourgeek.com. All rights reserved.
  * GPL3 Open Source Software License.
  */
package com.tourgeek.tour.message.jibx._2012B.base.response.in;
...
import com.tourgeek.tour.message.jibx._2012B.base.request.in.*;
 ...
 *  PingResponseJibxMessageIn2012B - .
 */
public class PingResponseJibxMessageIn2012B extends BaseJibxMessageIn2012B
{
    /**
     * Default constructor.
     */
    public PingResponseJibxMessageIn2012B()
    {
        super();
    }
    /**
     ...
     */
    public PingResponseJibxMessageIn2012B(ExternalTrxMessageIn message)
    {
        this();
        this.init(message);
    }
