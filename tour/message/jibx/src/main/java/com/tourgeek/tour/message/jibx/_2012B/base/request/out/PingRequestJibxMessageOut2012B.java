/**
  ...
  */
package com.tourgeek.tour.message.jibx._2012B.base.request.out;
 ...
 *  PingRequestJibxMessageOut2012B - .
 */
public class PingRequestJibxMessageOut2012B extends BaseJibxMessageOut2012B
{
    /**
     * Default constructor.
     */
    public PingRequestJibxMessageOut2012B()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestJibxMessageOut2012B(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
