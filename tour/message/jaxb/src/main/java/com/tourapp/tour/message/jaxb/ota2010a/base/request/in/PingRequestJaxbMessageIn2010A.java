/**
 *  @(#)PingRequestJaxbMessageIn2010A.
 *  Copyright © 2010 tourapp.com. All rights reserved.
 */
package com.tourapp.tour.message.jaxb.ota2010a.base.request.in;
 ...
 *  PingRequestJaxbMessageIn2010A - .
 */
public class PingRequestJaxbMessageIn2010A extends JaxbConvertToMessage
{
    /**
     * Default constructor.
     */
    public PingRequestJaxbMessageIn2010A()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestJaxbMessageIn2010A(ExternalTrxMessageIn message)
    {
        this();
        this.init(message);
    }
