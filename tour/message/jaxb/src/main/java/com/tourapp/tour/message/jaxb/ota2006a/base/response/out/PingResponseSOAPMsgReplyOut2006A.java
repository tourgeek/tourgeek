/**
 *  @(#)PingResponseSOAPMsgReplyOut2006A.
 *  Copyright © 2010 tourapp.com. All rights reserved.
 */
package com.tourapp.tour.message.jaxb.ota2006a.base.response.out;
 ...
 *  PingResponseSOAPMsgReplyOut2006A - .
 */
public class PingResponseSOAPMsgReplyOut2006A extends JaxbConvertToNative
{
    /**
     * Default constructor.
     */
    public PingResponseSOAPMsgReplyOut2006A()
    {
        super();
    }
    /**
     ...
     */
    public PingResponseSOAPMsgReplyOut2006A(ExternalTrxMessageOut message)
    {
        this();
        this.init(message);
    }
