/**
 *  @(#)PingRequestSOAPMessageIn2006A.
 *  Copyright © 2010 tourapp.com. All rights reserved.
 */
package com.tourapp.tour.message.jaxb.ota2006a.base.request.in;
 ...
 *  PingRequestSOAPMessageIn2006A - .
 */
public class PingRequestSOAPMessageIn2006A extends JaxbConvertToMessage
{
    /**
     * Default constructor.
     */
    public PingRequestSOAPMessageIn2006A()
    {
        super();
    }
    /**
     ...
     */
    public PingRequestSOAPMessageIn2006A(ExternalTrxMessageIn message)
    {
        this();
        this.init(message);
    }
