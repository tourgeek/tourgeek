 ...
 *  ProductReplyOutErrorProcessor - .
 */
public class ProductReplyOutErrorProcessor extends ProductReplyErrorProcessor
{
    /**
     * Default constructor.
     */
    public ProductReplyOutErrorProcessor()
    {
        super();
    }
    /**
     * Constructor.
     */
    public ProductReplyOutErrorProcessor(RecordOwnerParent taskParent, Record recordMain, Map<String,Object> properties)
    {
        this();
