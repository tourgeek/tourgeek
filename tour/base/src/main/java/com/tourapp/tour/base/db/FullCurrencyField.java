...
public class FullCurrencyField extends CurrencyField
{
    ...
    public ScreenField setupDefaultView(ScreenLocation itsLocation, BasePanel targetScreen, Converter converter, int iDisplayFieldDesc)
    {
        ...
        {
            Record recCurrencys = targetScreen.getRecord(Currencys.kCurrencysFile);
            if (recCurrencys != null)
            {
                BaseField fldCurrencyCode = recCurrencys.getField(Currencys.kCurrencyCode);
                Converter conv = new FieldDescConverter(fldCurrencyCode, converter);    // Use the description for this field
                ScreenField sfCurrency = new SEditText(itsLocation, targetScreen, conv, iDisplayFieldDesc);
