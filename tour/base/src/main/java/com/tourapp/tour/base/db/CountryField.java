 ...
 */
public class CountryField extends ReferenceField
{
    /**
     * Default constructor.
     */
     ...
     */
    public CountryField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new Country(recordOwner);
    }
    /**
