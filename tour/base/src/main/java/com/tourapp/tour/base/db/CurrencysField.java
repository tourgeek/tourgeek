 ...
 */
public class CurrencysField extends ReferenceField
{
    /**
     * Default constructor.
     */
    public CurrencysField()
    {
        super();
    }
    /**
     ...
     */
    public CurrencysField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new Currencys(recordOwner);
    }
    /**
