...
package com.tourgeek.tour.base.screen;
...
/**
 *  CurrencysGridScreen - Currencies.
 */
public class CurrencysGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public CurrencysGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public CurrencysGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(Currencys.CURRENCYS_FILE).getField(Currencys.LAST_RATE).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
