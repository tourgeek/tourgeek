...
/**
 *  BookingLandGridScreen - Land detail file.
 */
public class BookingLandGridScreen extends BookingDetailSubGridScreen
{
    /**
     * Default constructor.
     */
    public BookingLandGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public BookingLandGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(BookingLand.BOOKING_LAND_FILE).getField(BookingLand.STATUS_SUMMARY).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
    }
