...
public class TestHotelRateScreen extends Screen
{
    ...
    {
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.PRODUCT_ID).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.RATE_ID).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.CLASS_ID).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.DETAIL_DATE).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.TOTAL_COST).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(TestHotelRateScreenRecord.TEST_HOTEL_RATE_SCREEN_RECORD_FILE).getField(TestHotelRateScreenRecord.DISPLAY_COST_STATUS_ID).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
