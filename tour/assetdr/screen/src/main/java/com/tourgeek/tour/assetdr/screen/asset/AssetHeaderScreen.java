...
public class AssetHeaderScreen extends HeaderScreen
{
     ...
     */
    public AssetHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
