...
/**
 *  BankTrxBatchGridScreen - Bank Transaction Entry batch screen.
 */
public class BankTrxBatchGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public BankTrxBatchGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public BankTrxBatchGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    {
        return "Bank Transaction Entry batch screen";
    }
    /**
