...
/**
 *  AmountTextField - Convert this amount to text.
 */
public class AmountTextField extends CurrencyField
{
    /**
     * Default constructor.
     */
     ...
     */
    public AmountTextField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
