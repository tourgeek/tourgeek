 ...
 *  CruiseAvailabilityRequest - .
 */
public class CruiseAvailabilityRequest extends ProductAvailabilityRequest
{
    /**
     * Default constructor.
     */
    public CruiseAvailabilityRequest()
    {
        super();
    }
    /**
     * CruiseAvailabilityRequest Method.
     */
    public CruiseAvailabilityRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
