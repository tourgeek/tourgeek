     ...
     implements TourTypeModel
{
    ...
    public static final int kTourTypeLastField = kCode;
    public static final int kTourTypeFields = kCode - DBConstants.MAIN_FIELD + 1;
     ...
     * Constructor.
     */
    public TourType(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourTypeFile = "TourType";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourTypeFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourTypeLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kTourTypeLastKey)
        {
