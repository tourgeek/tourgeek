 ...
 *  CarClassField - .
 */
public class CarClassField extends BaseClassField
{
    /**
     * Default constructor.
     */
    public CarClassField()
    {
        super();
    }
    /**
     ...
     */
    public CarClassField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
