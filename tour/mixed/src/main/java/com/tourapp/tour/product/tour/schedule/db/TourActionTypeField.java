 ...
 *  TourActionTypeField - .
 */
public class TourActionTypeField extends StringPopupField
{
    public static final String TRIGGER_EVENT = "T";
    public static final String CREATE_DOCUMENT = "C";
    /**
     * Default constructor.
     */
    public TourActionTypeField()
    {
        super();
    }
    /**
     ...
     */
    public TourActionTypeField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
