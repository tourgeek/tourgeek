 ...
 *  TourHeaderItem - .
 */
public class TourHeaderItem extends TourHeaderDetail
     implements TourHeaderItemModel
{
    ...
    public static final int kTourHeaderItemLastField = kTourHeaderDetailLastField;
    public static final int kTourHeaderItemFields = kTourHeaderDetailLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    public TourHeaderItem()
    {
        super();
    }
    /**
     * Constructor.
     */
    public TourHeaderItem(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderItemFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderItemFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_ITEM_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_ITEM_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new ItemField(this, "ProductID", 8, null, null);
        if (iFieldSeq == kRateID)
            field = new ItemRateSelect(this, "RateID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == kClassID)
            field = new ItemClassSelect(this, "ClassID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderItemLastField)
