     ...
     implements AirInventoryModel
{
    ...
    public static final int kAirInventoryLastField = kInventoryLastField;
    public static final int kAirInventoryFields = kInventoryLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    public AirInventory()
    ...
    public static final String kAirInventoryFile = "Inventory";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kAirInventoryFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        {
            field = new AirRateSelect(this, "RateID", Constants.DEFAULT_FIELD_LENGTH, null, new Integer(Inventory.NO_RATE));
            field.setNullable(false);
            field.addListener(new InitOnceFieldHandler(null));
        }
        if (iFieldSeq == kClassID)
        {
            field = new AirClassSelect(this, "ClassID", Constants.DEFAULT_FIELD_LENGTH, null, new Integer(Inventory.NO_CLASS));
            field.setNullable(false);
            field.addListener(new InitOnceFieldHandler(null));
        }
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kAirInventoryLastField)
    ...
    public void addListeners()
    {
        ...
        this.addListener(new SharedFileHandler(Inventory.kProductTypeID, ProductType.AIR_ID));
    }
