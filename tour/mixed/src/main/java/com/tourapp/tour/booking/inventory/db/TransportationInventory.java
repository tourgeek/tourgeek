     ...
     implements TransportationInventoryModel
{
    ...
    public static final int kTransportationInventoryLastField = kInventoryLastField;
    public static final int kTransportationInventoryFields = kInventoryLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
     ...
     * Constructor.
     */
    public TransportationInventory(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTransportationInventoryFile = "Inventory";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTransportationInventoryFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        {
            field = new TransportationRateSelect(this, "RateID", Constants.DEFAULT_FIELD_LENGTH, null, new Integer(Inventory.NO_RATE));
            field.setNullable(false);
            field.addListener(new InitOnceFieldHandler(null));
        }
        if (iFieldSeq == kClassID)
        {
            field = new TransportationClassSelect(this, "ClassID", Constants.DEFAULT_FIELD_LENGTH, null, new Integer(Inventory.NO_CLASS));
            field.setNullable(false);
            field.addListener(new InitOnceFieldHandler(null));
        }
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTransportationInventoryLastField)
    ...
    public void addListeners()
    {
        ...
        this.addListener(new SharedFileHandler(Inventory.PRODUCT_TYPE_ID, ProductType.TRANSPORTATION_ID));
    }
