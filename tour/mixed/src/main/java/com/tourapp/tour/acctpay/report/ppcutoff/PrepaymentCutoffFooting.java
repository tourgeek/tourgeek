 ...
 *  PrepaymentCutoffFooting - .
 */
public class PrepaymentCutoffFooting extends HeadingScreen
{
    /**
     * Default constructor.
     */
    public PrepaymentCutoffFooting()
    {
        super();
    }
    /**
     ...
     */
    public PrepaymentCutoffFooting(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
