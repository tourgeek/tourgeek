...
public class TourHeaderTransport extends TourHeaderDetail
{
    ...
    public static final int kTourHeaderTransportLastField = kTourHeaderDetailLastField;
    public static final int kTourHeaderTransportFields = kTourHeaderDetailLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    public TourHeaderTransport()
    {
        super();
    }
    /**
     * Constructor.
     */
    public TourHeaderTransport(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderTransportFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderTransportFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderTransportLastField)
