...
public class TourHeaderScreenRecord extends ProductScreenRecord
{
    ...
    public static final String TOUR_HEADER_SCREEN_RECORD_FILE = null; // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        //if (iFieldSeq == 15)
        //  field = new TourHeaderScreenRecord_LastChanged(this, LAST_CHANGED, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 16)
        ...
        if (iFieldSeq == 24)
            field = new DisplayTypeField(this, DISPLAY_TYPE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 25)
        ...
        if (iFieldSeq == 27)
            field = new TourTypeSelect(this, TOUR_TYPE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 28)
            field = new DateField(this, START_DEPARTURE_DATE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 29)
            field = new DateField(this, END_DEPARTURE_DATE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 30)
            field = new ShortField(this, KEY_ORDER, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (field == null)
