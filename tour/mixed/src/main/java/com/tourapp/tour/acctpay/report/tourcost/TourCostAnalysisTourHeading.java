 ...
 *  TourCostAnalysisTourHeading - .
 */
public class TourCostAnalysisTourHeading extends ReportBreakScreen
{
    /**
     * Default constructor.
     */
    public TourCostAnalysisTourHeading()
    {
        super();
    }
    /**
     ...
     */
    public TourCostAnalysisTourHeading(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
