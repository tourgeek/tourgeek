/**
 *  @(#)ProductRateRequestMessageInProcessor.
 ...
 *  ProductRateRequestMessageInProcessor - .
 */
public class ProductRateRequestMessageInProcessor extends BaseMessageInProcessor
{
    /**
     * Default constructor.
     */
    public ProductRateRequestMessageInProcessor()
    {
        super();
    }
    /**
     * Constructor.
     */
    public ProductRateRequestMessageInProcessor(RecordOwnerParent taskParent, Record recordMain, Map<String,Object> properties)
    {
        this();
    ...
    public BaseMessage processMessage(BaseMessage internalMessage)
    {
        ...
        if (productMessageDesc != null)
        {
            for (int index = 1; ;index++)
            {
                ...
                messageReply = recProduct.processCostRequestInMessage(internalMessage, messageReply);
            }
        }
        return messageReply;
    }
