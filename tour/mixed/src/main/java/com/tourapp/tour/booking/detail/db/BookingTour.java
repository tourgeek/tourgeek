...
import com.tourapp.tour.message.tour.response.in.*;
     ...
     implements BookingTourModel
{
    ...
    public static final int kBookingTourLastField = kBookingDetailLastField;
    public static final int kBookingTourFields = kBookingDetailLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    public BookingTour()
    ...
    public static final String kBookingTourFile = "BookingDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kBookingTourFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(BOOKING_TOUR_DETAIL_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(BOOKING_TOUR_DETAIL_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new TourProductField(this, "ProductID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kBookingTourLastField)
