...
/**
 *  TourHeaderLand - Land Detail.
 */
public class TourHeaderLand extends TourHeaderDetail
     implements TourHeaderLandModel
{
    ...
    public static final int kTourHeaderLandLastField = kTourHeaderDetailLastField;
    public static final int kTourHeaderLandFields = kTourHeaderDetailLastField - DBConstants.MAIN_FIELD + 1;
    ...
    public static final int kTourHeaderLandLastKey = kProductIDKey;
    public static final int kTourHeaderLandKeys = kProductIDKey - DBConstants.MAIN_KEY_FIELD + 1;
    /**
     * Default constructor.
     */
    public TourHeaderLand()
    {
        super();
    }
    /**
     * Constructor.
     */
    public TourHeaderLand(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderLandFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderLandFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_LAND_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_LAND_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new LandField(this, "ProductID", 8, null, null);
        if (iFieldSeq == kRateID)
            field = new LandRateSelect(this, "RateID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == kClassID)
            field = new LandClassSelect(this, "ClassID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        ...
        if (iFieldSeq == kCityID)
            field = new UnusedField(this, "CityID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == kCityCode)
            field = new UnusedField(this, "CityCode", 3, null, null);
        if (iFieldSeq == kToCityID)
            field = new UnusedField(this, "ToCityID", Constants.DEFAULT_FIELD_LENGTH, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderLandLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kTourHeaderLandLastKey)
        {
    ...
    public void addListeners()
    {
        ...
        this.addListener(new SharedFileHandler(TourHeaderDetail.kProductTypeID, ProductType.LAND_ID));
    }
