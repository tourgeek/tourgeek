...
/**
 *  McoSubmitHeading - Heading for MCO Submission Report.
 */
public class McoSubmitHeading extends HeadingScreen
{
    /**
     * Default constructor.
     */
    public McoSubmitHeading()
    {
        super();
    }
    /**
     ...
     */
    public McoSubmitHeading(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    {
        return "Heading for MCO Submission Report";
    }
    /**
     * SetupSFields Method.
     */
