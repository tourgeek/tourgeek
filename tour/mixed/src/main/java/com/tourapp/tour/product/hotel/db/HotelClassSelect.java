...
/**
 *  HotelClassSelect - Same as HotelClass + Null opt.
 */
public class HotelClassSelect extends HotelClassField
{
    /**
     * Default constructor.
     */
    public HotelClassSelect()
    {
        super();
    }
    /**
     ...
     */
    public HotelClassSelect(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
