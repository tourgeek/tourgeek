...
public class BrokerDistScreen extends DetailScreen
{
    ...
    public void addListeners()
    {
        ...
        //xthis.getScreenRecord().getField(BrokerScreenRecord.kVendorID).addListener(new FieldReSelectHandler(this));
        ...
        recApTrx.getField(ApTrx.kInvoiceLocal).addListener(new CalcBalanceHandler(recApTrx.getField(ApTrx.kDepartureExchange), recApTrx.getField(ApTrx.kInvoiceLocal), recApTrx.getField(ApTrx.kInvoiceAmount), CalcBalanceHandler.DIVIDE, true));
