 ...
 *  TicketReportOrderField - .
 */
public class TicketReportOrderField extends ShortField
{
    /**
     * Default constructor.
     */
    public TicketReportOrderField()
    {
        super();
    }
    /**
     ...
     */
    public TicketReportOrderField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
