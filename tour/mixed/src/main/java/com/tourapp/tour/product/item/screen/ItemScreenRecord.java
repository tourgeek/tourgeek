...
public class ItemScreenRecord extends ProductScreenRecord
{
    ...
    public static final String ITEM_SCREEN_RECORD_FILE = null;  // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        //if (iFieldSeq == 15)
        //  field = new ItemScreenRecord_LastChanged(this, LAST_CHANGED, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 16)
