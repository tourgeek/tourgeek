 ...
 */
public class GetCarCostHandler extends GetProductCostHandler
{
    /**
     * Default constructor.
     */
    public GetCarCostHandler()
    {
        super();
    }
    /**
     * GetCarCostHandler Method.
     */
    public GetCarCostHandler(Record recProductVars, Integer intRegistryID)
    {
        this();
