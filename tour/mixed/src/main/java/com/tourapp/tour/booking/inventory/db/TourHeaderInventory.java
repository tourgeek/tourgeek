     ...
     implements TourHeaderInventoryModel
{
    ...
    public static final int kTourHeaderInventoryLastField = kInventoryLastField;
    public static final int kTourHeaderInventoryFields = kInventoryLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    ...
    public static final String kTourHeaderInventoryFile = "Inventory";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderInventoryFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        {
            field = new TourHeaderField(this, "ProductID", Constants.DEFAULT_FIELD_LENGTH, null, null);
            field.setNullable(false);
        }
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderInventoryLastField)
