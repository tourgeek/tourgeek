...
public class PaymentHistoryHeaderScreen extends HeaderScreen
{
     ...
     */
    public PaymentHistoryHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc)
    {
        this();
    ...
    {
        this.getRecord(PaymentHistory.kPaymentHistoryFile).getField(PaymentHistory.kID).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        ...
        this.getRecord(PaymentHistory.kPaymentHistoryFile).getField(PaymentHistory.kAmountLocal).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
