...
/**
 *  BookingSubScreen - Booking Sub-screen.
 */
public class BookingSubScreen extends Screen
{
    /**
     * Default constructor.
     */
    public BookingSubScreen()
    {
        super();
    }
    /**
     ...
     */
    public BookingSubScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
