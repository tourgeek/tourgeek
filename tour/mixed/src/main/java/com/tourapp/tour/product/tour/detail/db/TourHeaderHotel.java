     ...
     implements TourHeaderHotelModel
{
    ...
    public static final int kTourHeaderHotelLastField = kTourHeaderDetailLastField;
    public static final int kTourHeaderHotelFields = kTourHeaderDetailLastField - DBConstants.MAIN_FIELD + 1;
    ...
    public static final int kTourHeaderHotelLastKey = kProductIDKey;
    public static final int kTourHeaderHotelKeys = kProductIDKey - DBConstants.MAIN_KEY_FIELD + 1;
    /**
     * Default constructor.
     */
     ...
     * Constructor.
     */
    public TourHeaderHotel(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderHotelFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderHotelFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_HOTEL_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_HOTEL_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new HotelField(this, "ProductID", 8, null, null);
        if (iFieldSeq == kRateID)
            field = new HotelRateSelect(this, "RateID", 2, null, null);
        if (iFieldSeq == kClassID)
            field = new HotelClassSelect(this, "ClassID", 2, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderHotelLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kTourHeaderHotelLastKey)
        {
