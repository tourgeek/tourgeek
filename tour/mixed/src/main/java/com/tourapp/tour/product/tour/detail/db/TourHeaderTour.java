     ...
     implements TourHeaderTourModel
{
    ...
    public static final int kTourHeaderTourLastField = kTourHeaderDetailLastField;
    public static final int kTourHeaderTourFields = kTourHeaderDetailLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
     ...
     * Constructor.
     */
    public TourHeaderTour(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderTourFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderTourFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_TOUR_HEADER_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_TOUR_HEADER_GRID_SCREEN_CLAS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new TourHeaderSelect(this, "ProductID", 8, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderTourLastField)
    ...
    public void addListeners()
    {
        ...
        this.addListener(new SharedFileHandler(TourHeaderDetail.kProductTypeID, ProductType.TOUR_ID));
    }
