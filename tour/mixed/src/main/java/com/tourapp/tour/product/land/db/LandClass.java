     ...
     implements LandClassModel
{
    ...
    public static final int kLandClassLastField = kBaseClassLastField;
    public static final int kLandClassFields = kBaseClassLastField - DBConstants.MAIN_FIELD + 1;
     ...
     * Constructor.
     */
    public LandClass(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kLandClassFile = "LandClass";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kLandClassFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kLandClassLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kLandClassLastKey)
        {
