 ...
 *  ItemAvailabilityRequest - .
 */
public class ItemAvailabilityRequest extends ProductAvailabilityRequest
{
    /**
     * Default constructor.
     */
    public ItemAvailabilityRequest()
    {
        super();
    }
    /**
     * ItemAvailabilityRequest Method.
     */
    public ItemAvailabilityRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
