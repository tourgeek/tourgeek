     ...
     implements TourHeaderCarModel
{
    ...
    //public static final int kInventory = kInventory;
    //public static final int kSendTourOrder = kSendTourOrder;
    public static final int kTourHeaderCarLastField = kTourHeaderTransportLastField;
    public static final int kTourHeaderCarFields = kTourHeaderTransportLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
    ...
    public static final String kTourHeaderCarFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderCarFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_CAR_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_CAR_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        //  field = new (this, "Inventory", Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == kSendTourOrder)
        //  field = new (this, "SendTourOrder", Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (field == null)
        {
            field = super.setupField(iFieldSeq);
            if (field == null) if (iFieldSeq < kTourHeaderCarLastField)
