 ...
 *  BookingOrTourField - .
 */
public class BookingOrTourField extends StringPopupField
{
     ...
     */
    public BookingOrTourField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
