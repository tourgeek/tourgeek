...
public class InventoryStatus extends BaseDataStatus
{
    ...
    public static final int kInventoryStatusLastField = kBaseDataStatusLastField;
    public static final int kInventoryStatusFields = kBaseDataStatusLastField - DBConstants.MAIN_FIELD + 1;
     ...
     * Constructor.
     */
    public InventoryStatus(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kInventoryStatusFile = "InventoryStatus";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kInventoryStatusFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kInventoryStatusLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kInventoryStatusLastKey)
        {
