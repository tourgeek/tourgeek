     ...
     implements PricingTypeModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(PRICING_TYPE_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 4)
            field = new IntegerField(this, PRICING_CODES, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (field == null)
