 ...
 *  TourHeaderOptionField - .
 */
public class TourHeaderOptionField extends ReferenceField
{
    /**
     * Default constructor.
     */
    public TourHeaderOptionField()
    {
        super();
    }
    /**
     ...
     */
    public TourHeaderOptionField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new TourHeaderOption(recordOwner);
    }
    /**
