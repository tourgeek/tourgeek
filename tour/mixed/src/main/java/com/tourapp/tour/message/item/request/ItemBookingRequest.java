 ...
 *  ItemBookingRequest - .
 */
public class ItemBookingRequest extends ProductBookingRequest
{
    /**
     * Default constructor.
     */
    public ItemBookingRequest()
    {
        super();
    }
    /**
     * ItemBookingRequest Method.
     */
    public ItemBookingRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
