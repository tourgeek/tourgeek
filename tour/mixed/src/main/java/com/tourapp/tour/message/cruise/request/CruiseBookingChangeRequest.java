 ...
 *  CruiseBookingChangeRequest - .
 */
public class CruiseBookingChangeRequest extends CruiseBookingRequest
{
    /**
     * Default constructor.
     */
    public CruiseBookingChangeRequest()
    {
        super();
    }
    /**
     * CruiseBookingChangeRequest Method.
     */
    public CruiseBookingChangeRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
