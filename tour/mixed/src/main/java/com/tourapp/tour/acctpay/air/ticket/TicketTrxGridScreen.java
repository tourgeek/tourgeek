 ...
 */
public class TicketTrxGridScreen extends VendorApTrxGridScreen
{
    /**
     * Default constructor.
     */
    public TicketTrxGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public TicketTrxGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
