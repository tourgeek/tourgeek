...
public class PricingStatus extends BaseStatus
{
    ...
    public static final int kPricingStatusLastField = kBaseStatusLastField;
    public static final int kPricingStatusFields = kBaseStatusLastField - DBConstants.MAIN_FIELD + 1;
     ...
     * Constructor.
     */
    public PricingStatus(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kPricingStatusFile = "PricingStatus";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kPricingStatusFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kPricingStatusLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kPricingStatusLastKey)
        {
