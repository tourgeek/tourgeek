     ...
     implements BookingLandModel
{
    ...
    public static final int kBookingLandLastField = kBookingDetailLastField;
    public static final int kBookingLandFields = kBookingDetailLastField - DBConstants.MAIN_FIELD + 1;
    ...
    public static final int kBookingLandLastKey = kTourIDKey;
    public static final int kBookingLandKeys = kTourIDKey - DBConstants.MAIN_KEY_FIELD + 1;
    /**
     * Default constructor.
     */
    public BookingLand()
    ...
    public static final String kBookingLandFile = "BookingDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kBookingLandFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(BOOKING_LAND_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(BOOKING_LAND_GRID_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kBookingLandLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kBookingLandLastKey)
        {
