     ...
     implements BookingItemModel
{
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 17)
            field = new ItemRateField(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 18)
            field = new ItemClassField(this, CLASS_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 19)
