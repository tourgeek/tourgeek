 ...
 *  EventOrDateField - .
 */
public class EventOrDateField extends StringPopupField
{
     ...
     */
    public EventOrDateField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
