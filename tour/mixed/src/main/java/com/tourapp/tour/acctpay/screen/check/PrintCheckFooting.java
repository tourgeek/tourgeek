 ...
 *  PrintCheckFooting - .
 */
public class PrintCheckFooting extends HeadingScreen
{
    /**
     * Default constructor.
     */
    public PrintCheckFooting()
    {
        super();
    }
    /**
     ...
     */
    public PrintCheckFooting(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
