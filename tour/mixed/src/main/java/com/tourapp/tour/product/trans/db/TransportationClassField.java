 ...
 *  TransportationClassField - .
 */
public class TransportationClassField extends BaseClassField
{
    /**
     * Default constructor.
     */
    public TransportationClassField()
    {
        super();
    }
    /**
     ...
     */
    public TransportationClassField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
