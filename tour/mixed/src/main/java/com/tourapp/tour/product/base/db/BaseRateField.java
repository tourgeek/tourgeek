 ...
 *  BaseRateField - .
 */
public class BaseRateField extends ReferenceField
{
    /**
     * Default constructor.
     */
    public BaseRateField()
    {
        super();
    }
    /**
     ...
     */
    public BaseRateField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
