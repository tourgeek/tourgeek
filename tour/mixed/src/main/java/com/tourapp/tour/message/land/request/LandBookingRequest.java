 ...
 *  LandBookingRequest - .
 */
public class LandBookingRequest extends ProductBookingRequest
{
    /**
     * Default constructor.
     */
    public LandBookingRequest()
    {
        super();
    }
    /**
     * LandBookingRequest Method.
     */
    public LandBookingRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
