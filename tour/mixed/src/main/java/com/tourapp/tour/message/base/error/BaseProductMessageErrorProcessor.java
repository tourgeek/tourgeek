/**
 * @(#)BaseProductMessageErrorProcessor.
 ...
 *  BaseProductMessageErrorProcessor - .
 */
public class BaseProductMessageErrorProcessor extends BaseMessageErrorProcessor
{
    /**
     * Default constructor.
     */
    public BaseProductMessageErrorProcessor()
    {
        super();
    }
    /**
     * Constructor.
     */
    public BaseProductMessageErrorProcessor(RecordOwnerParent taskParent, Record recordMain, Map<String,Object> properties)
    {
        this();
