...
/**
 *  OverrideScreen - Enter override information.
 */
public class OverrideScreen extends Screen
{
    /**
     * Default constructor.
     */
     ...
     */
    public OverrideScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
