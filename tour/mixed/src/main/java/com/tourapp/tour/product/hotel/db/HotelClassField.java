...
/**
 *  HotelClassField - Hotel Class ID.
 */
public class HotelClassField extends BaseClassField
{
    /**
     * Default constructor.
     */
    public HotelClassField()
    {
        super();
    }
    /**
     ...
     */
    public HotelClassField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
