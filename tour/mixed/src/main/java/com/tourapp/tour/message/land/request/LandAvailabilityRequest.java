 ...
 *  LandAvailabilityRequest - .
 */
public class LandAvailabilityRequest extends ProductAvailabilityRequest
{
    /**
     * Default constructor.
     */
    public LandAvailabilityRequest()
    {
        super();
    }
    /**
     * LandAvailabilityRequest Method.
     */
    public LandAvailabilityRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
