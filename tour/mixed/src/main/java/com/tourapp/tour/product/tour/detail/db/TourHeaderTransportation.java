     ...
     implements TourHeaderTransportationModel
{
    ...
    public static final int kTourHeaderTransportationLastField = kTourHeaderTransportLastField;
    public static final int kTourHeaderTransportationFields = kTourHeaderTransportLastField - DBConstants.MAIN_FIELD + 1;
    /**
     * Default constructor.
     */
     ...
     * Constructor.
     */
    public TourHeaderTransportation(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kTourHeaderTransportationFile = "TourHeaderDetail";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kTourHeaderTransportationFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseScreen makeScreen(ScreenLocation itsLocation, BasePanel parentScreen, int iDocMode, Map<String,Object> properties)
    {
        ...
        if ((iDocMode & ScreenConstants.MAINT_MODE) == ScreenConstants.MAINT_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_TRANSPORTATION_SCREEN_CLASS, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        if ((iDocMode & ScreenConstants.DISPLAY_MODE) == ScreenConstants.DISPLAY_MODE)
            screen = BaseScreen.makeNewScreen(TOUR_HEADER_TRANSPORTATION_GRID_SCREEN_C, itsLocation, parentScreen, iDocMode | ScreenConstants.DONT_DISPLAY_FIELD_DESC, properties, this, true);
        else
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == kProductID)
            field = new TransportationField(this, "ProductID", 8, null, null);
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kTourHeaderTransportationLastField)
