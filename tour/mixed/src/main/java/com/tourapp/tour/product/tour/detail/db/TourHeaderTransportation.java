     ...
     implements TourHeaderTransportationModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(TOUR_HEADER_TRANSPORTATION_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 9)
            field = new TransportationField(this, PRODUCT_ID, 8, null, null);
        if (iFieldSeq == 10)
