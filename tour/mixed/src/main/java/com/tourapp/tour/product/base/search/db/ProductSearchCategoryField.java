 ...
 *  ProductSearchCategoryField - .
 */
public class ProductSearchCategoryField extends ReferenceField
{
    /**
     * Default constructor.
     */
    public ProductSearchCategoryField()
    {
        super();
    }
    /**
     ...
     */
    public ProductSearchCategoryField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new ProductSearchCategory(recordOwner);
    }
    /**
