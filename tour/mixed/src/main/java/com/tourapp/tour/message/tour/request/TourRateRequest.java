 ...
 *  TourRateRequest - .
 */
public class TourRateRequest extends ProductRateRequest
{
    /**
     * Default constructor.
     */
    public TourRateRequest()
    {
        super();
    }
    /**
     * TourRateRequest Method.
     */
    public TourRateRequest(MessageDataParent messageDataParent, String strKey)
    {
        this();
