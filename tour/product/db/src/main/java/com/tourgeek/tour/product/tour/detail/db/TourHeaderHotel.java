     ...
     implements TourHeaderHotelModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(TOUR_HEADER_HOTEL_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 9)
            field = new HotelField(this, PRODUCT_ID, 8, null, null);
        if (iFieldSeq == 10)
            field = new HotelRateSelect(this, RATE_ID, 2, null, null);
        if (iFieldSeq == 11)
            field = new HotelClassSelect(this, CLASS_ID, 2, null, null);
        //if (iFieldSeq == 12)
