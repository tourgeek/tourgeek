     ...
     implements TourHeaderItemModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(TOUR_HEADER_ITEM_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 9)
            field = new ItemField(this, PRODUCT_ID, 8, null, null);
        if (iFieldSeq == 10)
            field = new ItemRateSelect(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 11)
            field = new ItemClassSelect(this, CLASS_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 12)
