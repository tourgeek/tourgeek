...
public class CruiseRateMessageListener extends ProductRateMessageListener
{
    ...
    /**
     * CruiseRateMessageListener Method.
     */
    public CruiseRateMessageListener(BaseMessageReceiver messageHandler, Record record, boolean bUpdateRecord, BaseMessageFilter messageFilter)
    {
        this();
    ...
    {
        return new CruiseRateResponse(message, null);
    }
