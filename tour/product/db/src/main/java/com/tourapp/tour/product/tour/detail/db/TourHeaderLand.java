     ...
     implements TourHeaderLandModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(TOUR_HEADER_LAND_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 9)
            field = new LandField(this, PRODUCT_ID, 8, null, null);
        if (iFieldSeq == 10)
            field = new LandRateSelect(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 11)
            field = new LandClassSelect(this, CLASS_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 12)
        ...
        if (iFieldSeq == 37)
            field = new UnusedField(this, CITY_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 38)
            field = new UnusedField(this, CITY_CODE, 3, null, null);
        if (iFieldSeq == 39)
            field = new UnusedField(this, TO_CITY_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 40)
