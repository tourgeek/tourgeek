 ...
 *  OTACodeTableScreen - .
 */
public class OTACodeTableScreen extends Screen
{
    /**
     * Default constructor.
     */
    public OTACodeTableScreen()
    {
        super();
    }
    /**
     ...
     */
    public OTACodeTableScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
