 ...
 */
public class OTACodeTableGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public OTACodeTableGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public OTACodeTableGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
