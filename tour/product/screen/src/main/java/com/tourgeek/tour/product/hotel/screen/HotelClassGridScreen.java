...
/**
 *  HotelClassGridScreen - Hotel classes.
 */
public class HotelClassGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public HotelClassGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public HotelClassGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
