 ...
 */
public class BookingStatusGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public BookingStatusGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public BookingStatusGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
