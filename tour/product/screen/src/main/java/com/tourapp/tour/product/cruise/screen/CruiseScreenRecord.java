...
public class CruiseScreenRecord extends ProductScreenRecord
{
    ...
    public static final String CRUISE_SCREEN_RECORD_FILE = null;    // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 11)
            field = new CruiseRateField(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 12)
            field = new CruiseClassField(this, CLASS_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 13)
        ...
        //if (iFieldSeq == 15)
        //  field = new CruiseScreenRecord_LastChanged(this, LAST_CHANGED, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 16)
