...
public class HotelHeaderScreen extends ProductHeaderScreen
{
     ...
     */
    public HotelHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
