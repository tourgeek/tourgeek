...
public class CarScreenRecord extends ProductScreenRecord
{
    ...
    public static final String CAR_SCREEN_RECORD_FILE = null; // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 11)
            field = new CarRateField(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 12)
        ...
        //if (iFieldSeq == 15)
        //  field = new CarScreenRecord_LastChanged(this, LAST_CHANGED, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 16)
