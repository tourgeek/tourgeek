...
public class AirScreenRecord extends ProductScreenRecord
{
    ...
    public static final String AIR_SCREEN_RECORD_FILE = null; // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (iFieldSeq == 11)
            field = new AirRateField(this, RATE_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 12)
        ...
        //if (iFieldSeq == 15)
        //  field = new AirScreenRecord_LastChanged(this, LAST_CHANGED, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 16)
