...
/**
 *  TourHeaderHotelGridScreen - Tour Hotel Detail.
 */
public class TourHeaderHotelGridScreen extends TourDetailGridScreen
{
    /**
     * Default constructor.
     */
    public TourHeaderHotelGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public TourHeaderHotelGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    /**
     * TourHeaderHotelGridScreen Method.
     */
    public TourHeaderHotelGridScreen(Record recTourHeader, Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object>
     properties)
    {
        this();
