...
/**
 *  PaymentRequestGridScreen - Payment Request.
 */
public class PaymentRequestGridScreen extends DetailGridScreen
{
    /**
     * Default constructor.
     */
    public PaymentRequestGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public PaymentRequestGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
