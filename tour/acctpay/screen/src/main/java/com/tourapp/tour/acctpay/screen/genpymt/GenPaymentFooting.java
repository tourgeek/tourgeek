 ...
 *  GenPaymentFooting - .
 */
public class GenPaymentFooting extends HeadingScreen
{
    /**
     * Default constructor.
     */
    public GenPaymentFooting()
    {
        super();
    }
    /**
     ...
     */
    public GenPaymentFooting(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
