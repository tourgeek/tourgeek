...
/**
 *  VendorCostAnalysisVenHeading - .
 */
public class VendorCostAnalysisVenHeading extends ReportBreakScreen
{
    /**
     * Default constructor.
     */
    public VendorCostAnalysisVenHeading()
    {
        super();
    }
    /**
     ...
     */
    public VendorCostAnalysisVenHeading(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
