...
public class PrepaymentCutoffScreenRecord extends ApReportScreenRecord
{
    ...
    public static final String VENDOR_TOTAL = "VendorTotal";
    public static final String VENDOR_TOTAL_USD = "VendorTotalUSD";
    public static final String VENDOR_BALANCE_TOTAL = "VendorBalanceTotal";
    public static final String VENDOR_BALANCE_TOTAL_USD = "VendorBalanceTotalUSD";
    public static final String CURR_TOTAL = "CurrTotal";
    public static final String CURR_TOTAL_USD = "CurrTotalUSD";
    public static final String CURR_BALANCE_TOTAL = "CurrBalanceTotal";
    public static final String CURR_BALANCE_TOTAL_USD = "CurrBalanceTotalUSD";
    public static final String TOTAL_USD = "TotalUSD";
    public static final String BALANCE_TOTAL_USD = "BalanceTotalUSD";
    /**
     * Default constructor.
     */
    ...
    public static final String PREPAYMENT_CUTOFF_SCREEN_RECORD_FILE = null;   // Screen field
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        //if (iFieldSeq == 0)
        //  field = new PrepaymentCutoffScreenRecord_ReportDate(this, REPORT_DATE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 1)
        //  field = new PrepaymentCutoffScreenRecord_ReportTime(this, REPORT_TIME, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 2)
        //  field = new PrepaymentCutoffScreenRecord_ReportUserI(this, REPORT_USER_ID, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 3)
        ...
        //if (iFieldSeq == 24)
        //  field = new PrepaymentCutoffScreenRecord_CutoffDate(this, CUTOFF_DATE, Constants.DEFAULT_FIELD_LENGTH, null, null);
        //if (iFieldSeq == 25)
        ...
        if (iFieldSeq == 39)
            field = new CurrencyField(this, VENDOR_TOTAL, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 40)
            field = new CurrencyField(this, VENDOR_TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 41)
            field = new CurrencyField(this, VENDOR_BALANCE_TOTAL, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 42)
            field = new CurrencyField(this, VENDOR_BALANCE_TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 43)
            field = new CurrencyField(this, CURR_TOTAL, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 44)
            field = new CurrencyField(this, CURR_TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 45)
            field = new CurrencyField(this, CURR_BALANCE_TOTAL, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 46)
            field = new CurrencyField(this, CURR_BALANCE_TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 47)
            field = new CurrencyField(this, TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (iFieldSeq == 48)
            field = new CurrencyField(this, BALANCE_TOTAL_USD, Constants.DEFAULT_FIELD_LENGTH, null, null);
        if (field == null)
