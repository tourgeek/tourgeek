...
/**
 *  PayTypeField - Pay Type.
 */
public class PayTypeField extends StringPopupField
{
    public static final String HOURLY = "H";
    public static final String SALARIED = "S";
    /**
     * Default constructor.
     */
    public PayTypeField()
     ...
     */
    public PayTypeField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
