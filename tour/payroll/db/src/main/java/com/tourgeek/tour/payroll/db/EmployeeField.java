...
/**
 *  EmployeeField - Employee popup.
 */
public class EmployeeField extends ReferenceField
{
    /**
     * Default constructor.
     */
     ...
     */
    public EmployeeField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new EmployeeLookup(recordOwner);
    }
    /**
