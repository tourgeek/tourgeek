...
/**
 *  EmployeeGridScreen - Employees.
 */
public class EmployeeGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public EmployeeGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public EmployeeGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(Employee.EMPLOYEE_FILE).getField(Employee.TAX_ID_NO).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
