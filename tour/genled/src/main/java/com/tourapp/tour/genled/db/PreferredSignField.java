...
/**
 *  PreferredSignField - Preferred Size - positive or negative..
 */
public class PreferredSignField extends StringField
{
     ...
     */
    public PreferredSignField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        if (tempString.equalsIgnoreCase(NEGATIVE))
            return 2;
