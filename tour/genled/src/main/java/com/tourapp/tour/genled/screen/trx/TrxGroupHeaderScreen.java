 ...
 *  TrxGroupHeaderScreen - .
 */
public class TrxGroupHeaderScreen extends HeaderScreen
{
    /**
     * Default constructor.
     */
    public TrxGroupHeaderScreen()
    {
        super();
    }
    /**
     ...
     */
    public TrxGroupHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
