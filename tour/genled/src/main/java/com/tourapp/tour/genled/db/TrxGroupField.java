 ...
 *  TrxGroupField - .
 */
public class TrxGroupField extends ReferenceField
{
    /**
     * Default constructor.
     */
    public TrxGroupField()
    {
        super();
    }
    /**
     ...
     */
    public TrxGroupField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new TrxGroup(recordOwner);
    }
    /**
