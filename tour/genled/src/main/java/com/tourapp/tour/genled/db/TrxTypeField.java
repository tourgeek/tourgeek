...
/**
 *  TrxTypeField - Transaction Type Field.
 */
public class TrxTypeField extends ReferenceField
{
    /**
     * Default constructor.
     */
     ...
     */
    public TrxTypeField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new TransactionType(recordOwner);
    }
    /**
