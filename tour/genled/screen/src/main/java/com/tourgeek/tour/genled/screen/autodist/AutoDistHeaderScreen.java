 ...
 *  AutoDistHeaderScreen - .
 */
public class AutoDistHeaderScreen extends HeaderScreen
{
    /**
     * Default constructor.
     */
    public AutoDistHeaderScreen()
    {
        super();
    }
    /**
     ...
     */
    public AutoDistHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
