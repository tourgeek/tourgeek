 ...
 *  FinStmtField - .
 */
public class FinStmtField extends ReferenceField
{
    /**
     * Default constructor.
     */
     ...
     */
    public FinStmtField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    {
        return new FinStmt(recordOwner);
    }
    /**
