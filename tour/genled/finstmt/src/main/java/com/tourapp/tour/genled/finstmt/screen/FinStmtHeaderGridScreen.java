...
/**
 *  FinStmtHeaderGridScreen - Financial Statements.
 */
public class FinStmtHeaderGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public FinStmtHeaderGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public FinStmtHeaderGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
