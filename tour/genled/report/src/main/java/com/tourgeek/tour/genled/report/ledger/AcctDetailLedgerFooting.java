...
/**
 *  AcctDetailLedgerFooting - Report footer for G/L Ledger report.
 */
public class AcctDetailLedgerFooting extends HeadingScreen
{
    /**
     * Default constructor.
     */
    public AcctDetailLedgerFooting()
    {
        super();
    }
    /**
     ...
     */
    public AcctDetailLedgerFooting(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    {
        return "Report footer for G/L Ledger report";
    }
    /**
     * SetupSFields Method.
     */
