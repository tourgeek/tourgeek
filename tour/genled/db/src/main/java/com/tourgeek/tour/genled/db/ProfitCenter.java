     ...
     implements ProfitCenterModel
{
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(PROFIT_CENTER_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        //}
        if (iFieldSeq == 3)
            field = new ShortField(this, PROFIT_CENTER_NO, 3, null, null);
        if (iFieldSeq == 4)
