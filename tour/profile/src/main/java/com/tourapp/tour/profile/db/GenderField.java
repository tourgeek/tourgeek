...
/**
 *  GenderField - Gender (Male or Female).
 */
public class GenderField extends StringField
{
     ...
     */
    public GenderField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
    ...
    public void init(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        ...
        m_iMaxLength = 1; // BaseField length
    }
    /**
