 ...
 *  EAddressStringField - .
 */
public class EAddressStringField extends StringField
{
    /**
     * Default constructor.
     */
    public EAddressStringField()
    {
        super();
    }
    /**
     ...
     */
    public EAddressStringField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
