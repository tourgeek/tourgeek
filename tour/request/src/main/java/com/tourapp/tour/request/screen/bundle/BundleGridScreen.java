...
/**
 *  BundleGridScreen - Brochure Bundles.
 */
public class BundleGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public BundleGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public BundleGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
