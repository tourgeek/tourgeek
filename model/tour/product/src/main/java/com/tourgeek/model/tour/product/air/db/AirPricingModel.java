...
public interface AirPricingModel extends ProductPricingModel
{
    ...
    public static final String AIR_PRICING_SCREEN_CLASS = "com.tourgeek.tour.product.air.screen.AirPricingScreen";
    public static final String AIR_PRICING_GRID_SCREEN_CLASS = "com.tourgeek.tour.product.air.screen.AirPricingGridScreen";

    public static final String AIR_PRICING_FILE = "AirPricing";
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.product.air.db.AirPricing";
    public static final String THICK_CLASS = "com.tourgeek.tour.product.air.db.AirPricing";
