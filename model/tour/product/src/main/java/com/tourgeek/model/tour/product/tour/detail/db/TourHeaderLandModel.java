...
public interface TourHeaderLandModel extends TourHeaderDetailModel
{
    ...
    public static final String TOUR_HEADER_LAND_SCREEN_CLASS = "com.tourgeek.tour.product.tour.detail.screen.TourHeaderLandScreen";
    public static final String TOUR_HEADER_LAND_GRID_SCREEN_CLASS = "com.tourgeek.tour.product.tour.detail.screen.TourHeaderLandGridScreen";

    public static final String TOUR_HEADER_LAND_FILE = "TourHeaderDetail";
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.product.tour.detail.db.TourHeaderLand";
    public static final String THICK_CLASS = "com.tourgeek.tour.product.tour.detail.db.TourHeaderLand";
