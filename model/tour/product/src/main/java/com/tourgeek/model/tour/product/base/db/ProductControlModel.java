...
public interface ProductControlModel extends Rec
{
    ...
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.product.base.db.ProductControl";
    public static final String THICK_CLASS = "com.tourgeek.tour.product.base.db.ProductControl";
