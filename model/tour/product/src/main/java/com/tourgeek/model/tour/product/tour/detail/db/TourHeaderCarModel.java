...
public interface TourHeaderCarModel extends TourHeaderTransportModel
{
    ...
    public static final String TOUR_HEADER_CAR_SCREEN_CLASS = "com.tourgeek.tour.product.tour.detail.screen.TourHeaderCarScreen";
    public static final String TOUR_HEADER_CAR_GRID_SCREEN_CLASS = "com.tourgeek.tour.product.tour.detail.screen.TourHeaderCarGridScreen";

    public static final String TOUR_HEADER_CAR_FILE = "TourHeaderDetail";
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.product.tour.detail.db.TourHeaderCar";
    public static final String THICK_CLASS = "com.tourgeek.tour.product.tour.detail.db.TourHeaderCar";
