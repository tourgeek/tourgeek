...
public interface McoBatchDistModel extends CashBatchDistModel
{
    ...
    public static final String MCO_BATCH_DIST_SCREEN_CLASS = "com.tourgeek.tour.acctrec.screen.mco.McoBatchDistScreen";
    ...
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.acctrec.db.McoBatchDist";
    public static final String THICK_CLASS = "com.tourgeek.tour.acctrec.db.McoBatchDist";
