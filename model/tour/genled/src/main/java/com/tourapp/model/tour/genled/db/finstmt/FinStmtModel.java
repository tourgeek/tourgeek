...
public interface FinStmtModel extends Rec
{
    ...
    public static final String THIN_CLASS = "com.tourapp.thin.tour.genled.db.finstmt.FinStmt";
    public static final String THICK_CLASS = "com.tourapp.tour.genled.db.finstmt.FinStmt";
