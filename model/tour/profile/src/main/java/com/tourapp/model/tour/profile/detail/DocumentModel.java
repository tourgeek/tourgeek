...
public interface DocumentModel extends Rec
{
    ...
    public static final String THIN_CLASS = "com.tourapp.thin.tour.profile.detail.Document";
    public static final String THICK_CLASS = "com.tourapp.tour.profile.detail.Document";
