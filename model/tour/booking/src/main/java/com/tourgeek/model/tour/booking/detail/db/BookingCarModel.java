...
public interface BookingCarModel extends BookingDetailModel
{
    ...
    public static final String BOOKING_CAR_SCREEN_CLASS = "com.tourgeek.tour.booking.entry.detail.car.BookingCarScreen";
    public static final String BOOKING_CAR_GRID_SCREEN_CLASS = "com.tourgeek.tour.booking.entry.detail.car.BookingCarGridScreen";

    public static final String BOOKING_CAR_FILE = "BookingDetail";
    public static final String THIN_CLASS = "com.tourgeek.thin.tour.booking.detail.db.BookingCar";
    public static final String THICK_CLASS = "com.tourgeek.tour.booking.detail.db.BookingCar";
