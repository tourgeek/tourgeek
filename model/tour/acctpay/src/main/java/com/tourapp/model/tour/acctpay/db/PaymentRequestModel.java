...
public interface PaymentRequestModel extends Rec
{
    ...
    public static final String PRINT_CHECK_JOURNAL_CLASS = "com.tourapp.tour.acctpay.screen.check.PrintCheckJournal";
    public static final String PRINT_CHECK_POST_CLASS = "com.tourapp.tour.acctpay.screen.check.PrintCheckPost";
